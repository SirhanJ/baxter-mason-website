      ...
      <div className="wrap">
        <a className="logo" href="/">
          ...
          <img
            ...
            src="/images/logos%20and%20sally%20stuff/Baxter-and-Mason-logo-light-clear.png"
            alt=""
            aria-hidden="true"
          />
        </a>
          ...
          <div className="final-panel rv">
            <div className="final-main">
              ...
              <h2 className="display">
                Have a quiet, honest conversation first.
              </h2>
              <p className="sub">
                No obligation and no pressure. Just a chance to talk through
              ...
              <div className="cta-row">
                ...
                <a
                  ...
                  href="mailto:mail@baxtermason.com.au"
                >
                  Email the Team
                </a>
              </div>
            ...
            <div className="final-side">
              <div className="final-side-inner">
                ...
                <div className="final-link is-static">
                  ...
                  <span className="final-link-v">
                    17 Baleara Street, Buddina QLD 4575
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="wrap">
          <div className="ft-top">
            <div className="brand-col">
              ...
              />
              <p className="blurb">
                A woman-led buyers agency on the Sunshine Coast. We help women
                buy homes and new-build investments with straight talk and a
                sharp eye for detail.
              </p>
              <div
                className="socials"
                aria-label="Follow Baxter and Mason on social media"
              >
                {(
                  [
                    [
            ...
            <div className="ft-col">
              ...
              <ul>
                ...
                <li>
                  <a href="mailto:mail@baxtermason.com.au">
                    mail@baxtermason.com.au
                  </a>
                </li>
                <li>
                  17 Baleara Street
          ...
          {showInsightsHead ? (
            <div className="head">
              ...
              <p className="intro rv d2">
                Practical notes on hot properties, competition, and finding a
                home that fits how you live.
              </p>
            </div>
          ) : null}
