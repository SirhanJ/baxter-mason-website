(function () {
  ...
  if (b && m) {
    ...
    document.querySelectorAll('.nav-desktop-cta, .nav-mobile-cta').forEach(function (a) {
      a.addEventListener('click', function () {
        closeMobileMenu();
      });
    });
  ...
  if (contactForm) {
    var VEXUR_FORM_SUBMIT_URL = 'https://iipazmwbtctblpyszspb.supabase.co/functions/v1/form-submit';
    ...
    var VEXUR_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlpcGF6bXdidGN0YmxweXN6c3BiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTgzNDEzODcsImV4cCI6MjA3MzkxNzM4N30.YQ2IaG-Uywn1zPeRnSOnY5O7WwdXT8QOAs0toHy1GUE';
  ...
  (function initVexurBooking() {
    ...
    var LOADER_INTEGRITY = 'sha384-dx3l2judEexylNgMj/LWd1UZOwIoR4gyPHKTfRUwtE/QSHhy/C1iYfOW0y4dKp62';
    var modal = null;
    var lastFocus = null;
